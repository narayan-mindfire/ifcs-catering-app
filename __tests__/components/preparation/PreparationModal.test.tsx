...
// Mock sub-modals
jest.mock("../../../src/components/flight-hub/PDFViewerModal", () => ({ PdfViewerModal: () => null }));
jest.mock("../../../src/components/preparation/ValidationModal", () => ({ ValidationModal: () => null }));
...
jest.mock("../../../src/components/flight-hub/FlightPreparationDetailsModal", () => ({ FlightPreparationDetailsModal: () => null }));
